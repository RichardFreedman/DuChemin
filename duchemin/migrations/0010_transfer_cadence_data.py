...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        for analysis in orm.DCAnalysis.objects.all():
            analysis.is_cadence = analysis.cadence in ("Yes", "yes", "True", "true")
            analysis.save()
        # Note: Remember to use orm['appname.ModelName'] rather than "from appname.models..."

    def backwards(self, orm):
        for analysis in orm.DCAnalysis.objects.all():
            analysis.cadence = "True" if analysis.is_cadence else None
            analysis.save()
