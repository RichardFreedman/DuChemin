...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'DCAnalysis.cadence'
        db.delete_column(u'duchemin_dcanalysis', 'cadence')


    def backwards(self, orm):
        # Adding field 'DCAnalysis.cadence'
        db.add_column(u'duchemin_dcanalysis', 'cadence',
