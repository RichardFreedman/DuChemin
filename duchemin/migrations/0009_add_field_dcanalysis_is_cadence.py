...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DCAnalysis.is_cadence'
        db.add_column(u'duchemin_dcanalysis', 'is_cadence',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DCAnalysis.is_cadence'
        db.delete_column(u'duchemin_dcanalysis', 'is_cadence')
