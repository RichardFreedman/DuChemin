...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DCPiece.audio_link'
        db.add_column(u'duchemin_dcpiece', 'audio_link',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DCPiece.audio_link'
        db.delete_column(u'duchemin_dcpiece', 'audio_link')
