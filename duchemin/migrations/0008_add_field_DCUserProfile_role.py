...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DCUserProfile.role'
        db.add_column(u'duchemin_dcuserprofile', 'role',
                      self.gf('django.db.models.fields.CharField')(max_length=64, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DCUserProfile.role'
        db.delete_column(u'duchemin_dcuserprofile', 'role')
