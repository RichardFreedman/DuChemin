...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'DCBook.cesr'
        db.alter_column(u'duchemin_dcbook', 'cesr', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

    def backwards(self, orm):

        # Changing field 'DCBook.cesr'
        db.alter_column(u'duchemin_dcbook', 'cesr', self.gf('django.db.models.fields.CharField')(max_length=16, null=True))
